 ...
 * Copyright (C) 2015, 2016, 2020, 2021, 2022, 2025  AO Industries, Inc.
...
public final class ApplicationResources extends EditableResourceBundle {
  ...
  static File getSourceFile(String filename) {
    try {
      return new File(System.getProperty("user.home") + "/maven2/ao/oss/servlet-util-javaee/src/main/resources/com/aoapps/servlet/http/i18n", filename);
