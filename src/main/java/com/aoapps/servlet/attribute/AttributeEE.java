...
public abstract class AttributeEE<C, T> extends com.aoapps.lang.attribute.Attribute<C, T> {
	...
	public static final class Page<T> extends AttributeEE<JspContext, T> {
		...
		public OldValue init(T value) {
			...
			if(value != oldValue) jspContext.setAttribute(name, value);
		...
		public OldValue init(int scope, T value) {
			...
			if(value != oldValue) jspContext.setAttribute(name, value, scope);
			return new OldValue(oldValue) {
				@Override
				public void close() {
		...
		public static <T, Ex extends Throwable> T compute(
			...
			synchronized(jspContext) {
				...
				if (newValue != oldValue) jspContext.setAttribute(name, newValue);
				return newValue;
			}
		}
		...
		public static <T, Ex extends Throwable> T compute(
			...
			synchronized(jspContext) {
				...
				T newValue = remappingFunction.apply(name, oldValue);
				if (newValue != oldValue) jspContext.setAttribute(name, newValue, scope);
				return newValue;
			}
		}
		...
		public static <T, Ex extends Throwable> T computeIfAbsent(
			...
			synchronized(jspContext) {
				...
				if(value == null) {
					...
					if(value != null) jspContext.setAttribute(name, value);
				}
				return value;
			}
		}
		...
		public static <T, Ex extends Throwable> T computeIfAbsent(
			...
			synchronized(jspContext) {
				...
				if(value == null) {
					value = mappingFunction.apply(name);
					if(value != null) jspContext.setAttribute(name, value, scope);
				}
				return value;
			}
		}
		...
		public static void remove(JspContext jspContext, String name) {
			if(jspContext != null) jspContext.removeAttribute(name, PageContext.PAGE_SCOPE);
		}
		...
		public static void remove(JspContext jspContext, int scope, String name) {
			if(jspContext != null) jspContext.removeAttribute(name, scope);
		}
		...
		public static <T> T replace(JspContext jspContext, String name, T value) {
			synchronized(jspContext) {
				...
				if(curValue != null) jspContext.setAttribute(name, value);
				return curValue;
			}
		}
		...
		public static <T> T replace(JspContext jspContext, int scope, String name, T value) {
			synchronized(jspContext) {
				...
				if(curValue != null) jspContext.setAttribute(name, value, scope);
				return curValue;
			}
		}
		...
		public static <T> T setIfAbsent(
			...
			synchronized(jspContext) {
				@SuppressWarnings("unchecked")
				T oldValue = (T)jspContext.getAttribute(name);
				if (oldValue == null) jspContext.setAttribute(name, value);
				return oldValue;
			}
		}
		...
		public static <T> T setIfAbsent(
			...
			synchronized(jspContext) {
				@SuppressWarnings("unchecked")
				T oldValue = (T)jspContext.getAttribute(name, scope);
				if (oldValue == null) jspContext.setAttribute(name, value, scope);
				return oldValue;
			}
		}
	...
	public static final class Request<T> extends AttributeEE<ServletRequest, T> {
		...
		public OldValue init(T value) {
			...
			if(value != oldValue) request.setAttribute(name, value);
			return new OldValue(oldValue) {
				@Override
				public void close() {
		...
		public static <T, Ex extends Throwable> T compute(
			...
			synchronized(request) {
				...
				T newValue = remappingFunction.apply(name, oldValue);
				if (newValue != oldValue) request.setAttribute(name, newValue);
				return newValue;
			}
		}
		...
		public static <T> T replace(
			...
			synchronized(request) {
				...
				if(curValue != null) request.setAttribute(name, value);
				return curValue;
			}
		}
		...
		public static <T> T setIfAbsent(
			...
			synchronized(request) {
				@SuppressWarnings("unchecked")
				T oldValue = (T)request.getAttribute(name);
				if (oldValue == null) request.setAttribute(name, value);
				return oldValue;
			}
		}
	...
	public static final class Session<T> extends AttributeEE<HttpSession, T> {
		...
		public OldValue init(T value) {
			...
			if(value != oldValue) session.setAttribute(name, value);
			return new OldValue(oldValue) {
				@Override
				public void close() {
					if(session != null) session.setAttribute(name, oldValue);
				}
			};
		}
		...
		public static <T, Ex extends Throwable> T compute(
			...
			synchronized(session) {
				...
				T newValue = remappingFunction.apply(name, oldValue);
				if (newValue != oldValue) session.setAttribute(name, newValue);
				return newValue;
			}
		}
		...
		public static <T> T replace(
			...
			if(session == null) {
				...
				synchronized(session) {
					...
					if(curValue != null) session.setAttribute(name, value);
					return curValue;
				}
			}
		}
		...
		public static <T> T setIfAbsent(
			...
			if(session == null && value == null) {
				...
				synchronized(session) {
					@SuppressWarnings({"unchecked", "null"})
					T oldValue = (T)session.getAttribute(name);
					if (oldValue == null) session.setAttribute(name, value);
					return oldValue;
				}
			}
		}
	...
	public static final class Application<T> extends AttributeEE<ServletContext, T> {
		...
		public OldValue init(T value) {
			...
			if(value != oldValue) servletContext.setAttribute(name, value);
			return new OldValue(oldValue) {
				@Override
				public void close() {
		...
		public static <T, Ex extends Throwable> T compute(
			...
			synchronized(servletContext) {
				...
				T newValue = remappingFunction.apply(name, oldValue);
				if (newValue != oldValue) servletContext.setAttribute(name, newValue);
				return newValue;
			}
		}
		...
		public static <T, Ex extends Throwable> T computeIfAbsent(
			...
			synchronized(servletContext) {
				...
				if(value == null) {
					value = mappingFunction.apply(name);
					if(value != null) servletContext.setAttribute(name, value);
				}
				return value;
			}
		}
		...
		public static void remove(ServletContext servletContext, String name) {
			if(servletContext != null) servletContext.removeAttribute(name);
		}
		...
		public static <T> T replace(
			...
			synchronized(servletContext) {
				...
				if(curValue != null) servletContext.setAttribute(name, value);
				return curValue;
			}
		}
		...
		public static <T> T setIfAbsent(
			...
			synchronized(servletContext) {
				@SuppressWarnings("unchecked")
				T oldValue = (T)servletContext.getAttribute(name);
				if (oldValue == null) servletContext.setAttribute(name, value);
				return oldValue;
			}
		}
	...
	public static class Name<T> extends com.aoapps.lang.attribute.Attribute.Name<T> {
		...
		public <C> ScopeEE.Attribute<C, T> scope(ScopeEE<C> scope) {
			if(scope == ScopeEE.PAGE) return (ScopeEE.Attribute<C, T>)application();
			if(scope == ScopeEE.REQUEST) return (ScopeEE.Attribute<C, T>)request();
			if(scope == ScopeEE.SESSION) return (ScopeEE.Attribute<C, T>)session();
			if(scope == ScopeEE.APPLICATION) return (ScopeEE.Attribute<C, T>)application();
